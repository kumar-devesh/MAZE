...
def attack():
    ...
    elif args.attack == "maze_edited":
        maze_edited(args, T, S, train_loader, test_loader, tar_acc)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attack', type=str, default="maze_edited", help='attack type')
    ...
    parser.add_argument('--latent_dim', type=int, default=10, help='latent dim for generator ((16x)*(16x)) generated image resolution')
    ...
    parser.add_argument('--lr_gen', type=float, default=1e-4, help='lr for generator model')  
    parser.add_argument('--lr_clone', type=float, default=0.001, help='lr for clone model') 
    ...
    parser.add_argument('--frame_repeat', type=str, default='1',
                        help='frame_repeat')
