...
def parse_arguments():
    ...
    parser.add_argument('--budget_gen', type=int, default=10, help='generator pretrain budget')
    parser.add_argument('--budget_clone', type=int, default=2, help='clone training on pretrained generator budget')
