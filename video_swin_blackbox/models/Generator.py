...
class Generator(nn.Module):
    ...
    def __init__(self, in_dim=120, latent_dim=7, n_class=400, ch=16, n_frames=8, hierar_flag=False, frame_repeat=4):
        super().__init__()
    ...
    def forward(self, x, class_id):
        ...
        y = F.relu(y)
        y = self.colorize(y)
        y = torch.repeat_interleave(y, self.frame_repeat, dim=2)
